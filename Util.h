...
namespace Util {
    namespace Convert {
        ...
        inline constexpr float DegsToRads(float fDegrees) { return fDegrees * MY_PI / 180.0f; }
        inline constexpr float RadsToDegs(float fRadians) { return fRadians * 180.0f / MY_PI; }
    }
